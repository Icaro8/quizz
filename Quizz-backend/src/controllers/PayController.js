...
mercadopago.configurations.setAccessToken("APP_USR-4805055530408040-073013-0690393933b2e9f1a161399ed373c156-798000392"); 
...
module.exports =  {
  ...
  async getPayment(req, res) {
    ...
    const token = "TEST-4805055530408040-073013-806939c741ac493a0ddb7d5cfc7caa10-798000392"
    ...
    await fetch(`https://api.mercadopago.com/v1/payments/${payment_id}`, {
      ...
      if (data.status === "approved"){
        ...
        const carteira = await Carteira.findOne({ where: { id: carteira_id } })
        ...
        return res.json({text:`valor da carteira atualizado. Total: ${carteira.valor}`, acao: historico_ficha.acao})
      }
